...
export const meetings: Meeting[] = [
  ...
  },
  {
    ...
    imageUrl: './assets/AWNW_Dental_Sleep_Medicine.png',
    type: 'ce',
    title: 'Cloud Dentistry CE Opportunity for San Antonio',
    subtitle: 'A Whole New World: Open Your Eyes to Dental Sleep Medicine',
    speaker: 'An Chih Do, RDH, MEd, MAADH',
    location:
      'Paloma Blanca Mexican Cuisine 5800 Broadway, Suite #300, San Antonio',
    description: `Cloud Dentistry hosts An Chih Do for a Happy Hour and 1-hour CE. Space is limited and registration is required. Please click here for more information and to complete registration. We are excited to attend this presentation and hope to see you there as well! Please note: Your CE certificate will be provided through Cloud Dentistry's platform.`,
  ...
  },
  {
    ...
    type: 'ce',
    title: 'Sponsored by Dental Partners and 3M.',
    subtitle: 'Sherlock Hygiene: A Study of Diabetes',
    description: 'RSVP By April 10th. Click or tap here to register.',
    speaker: 'Staci Janous, RDH, BS, MS',
    imageUrl: './assets/Janous April Event.png',
    location: '7 to 7 dental, 2211 NW Military Hwy, San Antonio, TX 78213',
  ...
  {
    date: new Date('09/21/2024 09:00 AM'),
    endDate: new Date('09/21/2024 12:00 PM'),
    type: 'general',
    title: 'SADHA General Meeting',
    description: 'Join SADHA for the September General Meeting!',
    location: '7 to 7 dental, 2211 NW Military Hwy, San Antonio, TX 78213',
    imageUrl: './assets/SelfCareForTheDentalHygienists_2024.png',
    link: 'https://lp.constantcontactpages.com/ev/reg/chp2nwa',
  },
  {
    date: new Date('12/07/2024 09:00 AM'),
  ...
  {
    date: new Date('03/08/2025 09:00 AM'),
  ...
  },
  {
    ...
    endDate: new Date('10/25/2024 04:00 PM'),
    type: 'project',
    title: '11th annual Smiles of Hope Clinic on October 25 (Hygiene Day)',
    description:
      'Please register to provide FREE dental care to underserved adults in our community!',
    location:
